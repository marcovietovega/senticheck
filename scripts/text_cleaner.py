...
class TextCleaner:
    ...
    def clean_post(
        ...
        Args:
            post_data: Post data dictionary with 'text' field
        ...
        Returns:
            Updated post data with cleaned text and metadata, or None if filtered
        """
...
def clean_bluesky_posts(
    ...
    Args:
        posts: List of post dictionaries from Bluesky
        preserve_hashtags: Whether to keep hashtags
        preserve_mentions: Whether to keep mentions
        filter_hashtag_only: Whether to filter posts that are mostly hashtags
        min_content_words: Minimum number of content words required
