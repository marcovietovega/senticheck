...
def get_trend_icon(change_value, neutral_threshold=2):
    """
    Get trend icon based on change value.
    
    Args:
        change_value: Numeric change value
        neutral_threshold: Threshold for considering change neutral
        
    Returns:
        Emoji string for trend
    """
    if change_value > neutral_threshold:
        return "📈"
    elif change_value < -neutral_threshold:
        return "📉"
    else:
        return "➡️"
