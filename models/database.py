...
class ProcessingLog(Base):
    """Model for logging processing activities and errors."""
...
class SearchHistory(Base):
    """Model for tracking search keywords and their usage."""
    ...
    posts_stored = Column(Integer, default=0)
    ...
    def __repr__(self):
        return f"<SearchHistory(id={self.id}, keyword={self.keyword}, posts_found={self.posts_found})>"
